...
image_speed = 1;
// Animation speed for idle and pre-hop animations
...
base_jump_power_horizontal = 2.5;
// Horizontal speed when jumping with direction
air_control_force = 0.3;          // How much keys affect hsp in air
max_hsp_air = 4;
// Max horizontal speed from air control input

// --- Wall Slide Variables ---
wall_slide_speed = 2; // Maximum speed when sliding down a wall

// Attack variables
arrow_angle = 90;
// Start at the top (90° = straight up in GameMaker)
arrow_speed = 2;
// Speed of arrow oscillation (degrees per step)
arrow_direction = 1;   // 1 = clockwise, -1 = counterclockwise
arrow_min_angle = -30;
// Minimum angle (-30° = top-right)
arrow_max_angle = 200; // Maximum angle (200° = top-left)
arrow_distance = 24;
// Distance of arrow from frog's center
can_attack = true;     // Whether player can attack

// Tongue variables
tongue_active = false;
// Whether the tongue is currently out
tongue_angle = 0;         // Angle of tongue extension
tongue_length = 0;
// Current tongue length
tongue_max_length = 120;   // Maximum tongue extension length
tongue_speed = 6;
// Speed of ton gue extension
tongue_retracting = false;// Whether tongue is extending (false) or retracting (true)
tongue_damage = 10;
// Damage dealt by tongue hit

// Damaged state variables
damaged_timer = 0;
damaged_duration = 20;
// Duration of damaged animation (adjust as needed)
damaged_frame = 0;
damaged_frame_speed = 10;
// Change frame every 10 steps

// Death variables
death_alpha = 1;         // For fading out effect
death_fade_speed = 0.02;
// How quickly the frog fades out (decrease alpha)
death_particle_created = false;

// Sound related variables
audio_charging = -1;
// ID for charging sound
audio_charging_playing = false; // Flag to track if charging sound is playing
audio_charging_max_reached = false;
// Flag to track if charge is at max
